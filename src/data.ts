...
export const PRODUCT_CATEGORIES = [
  ...
  { id: 'butt-hinges', name: 'Butt Hinges', description: 'Heavy-duty stainless steel hinges', image: '' },
  { id: 'aldrops', name: 'Aldrops', description: 'Premium door aldrops in multiple designs', image: '/images/aldrop/aldrop4.png' },
  ...
  { id: 'door-closers', name: 'Door Closers', description: 'Automatic hydraulic door closers', image: '/images/door-closer/dc2.png' },
  ...
  { id: 'tower-bolts', name: 'Tower Bolts', description: 'Premium stainless steel tower bolts', image: '' },
  ...
  { id: 'mirror-brackets', name: 'Mirror Brackets', description: 'Mirror support brackets and caps', image: '/images/mirror-bracket/mb5.png' },
  { id: 'd-brackets', name: 'D Brackets', description: 'Premium stainless steel D brackets', image: '' },
  { id: 'f-brackets', name: 'F Brackets', description: 'Heavy-duty glass F brackets', image: '' },
  { id: 'glass-hardware', name: 'Glass Hardware', description: 'Premium glass fittings, hinges and patch fittings', image: '/images/mirror-bracket/mb5.png' },
  { id: 'main-door-handles', name: 'Main Door Handles', description: 'Luxury entrance door handles', image: '' },
  { id: 'towel-racks', name: 'Folding Towel Racks', description: 'Premium folding towel racks', image: '' },
  { id: 'door-fittings', name: 'Door Fittings', description: 'Crem bolts, buffers, silencers and magnets', image: '' },
  ...
  { id: 'cloth-hangers', name: 'Cloth Hangers', description: 'Premium antique cloth hangers', image: '' },
  { id: 'door-stoppers', name: 'Door Stoppers', description: 'Heavy-duty door stoppers', image: '' },
  { id: 'safot', name: 'Safot', description: 'Safot door and window fittings', image: '' },
